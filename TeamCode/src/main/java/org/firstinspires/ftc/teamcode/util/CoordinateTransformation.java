...
public class CoordinateTransformation {
    ...
    public CoordinateTransformation(Vector3D o, Vector3D u1, Vector3D u2, Vector3D u3){
        this.o = o;
    ...
    public CoordinateTransformation(Vector3D o, Matrix3x3 R){
        this.o = o;
        this.R = R;
        RT = R.copyTranspose();
    }
    ...
    public Vector3D inverseTransform(Vector3D v){
        return RT.multiply(v.subtract(o));
    }

    /**
     * Merging two transformations, follows from the math:
     * v' = R1 * v + o1
     * v" = R2 * v' + o2
     *    = R2 * (R1 * v + o1) + o2
     *    = R2 * R1 * v + R2 * o1 + o2
     ...
     * @return
     */
    public CoordinateTransformation mergeToCombine(CoordinateTransformation t){
        return new CoordinateTransformation(R.multiply(t.o).add(o),
                new Matrix3x3().multiply(R, t.R));
    }
}
